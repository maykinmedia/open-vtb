...
EXPECTED_VERSIONS = (
    ("verzoeken", settings.VERZOEKEN_API_VERSION),
    ("taken", settings.TAKEN_API_VERSION),
    ("berichten", settings.BERICHTEN_API_VERSION),
)
...
class APIVersioningTests(APITestCase):
    ...
    @patch("openvtb.utils.middleware.get_version_mapping", return_value={"/": "1.0.0"})
    @override_settings(ROOT_URLCONF="openvtb.tests.api_strategy.urls")
