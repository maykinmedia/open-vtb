...
DATABASES = {
    "default": {
        ...
        "NAME": config("DB_NAME", "openvtb"),
        "USER": config("DB_USER", "openvtb"),
        "PASSWORD": config("DB_PASSWORD", "openvtb"),
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "openvtb.utils.context_processors.settings",
            ],
...
WSGI_APPLICATION = "openvtb.wsgi.application"
...
DEFAULT_FROM_EMAIL = config("DEFAULT_FROM_EMAIL", default="openvtb@example.com")
...
LOGGING = {
    ...
    "handlers": {
        ...
        "project": {
            "level": "DEBUG",
            "class": "logging.handlers.RotatingFileHandler",
            "filename": LOGGING_DIR / "openvtb.log",
            "formatter": "verbose",
            "maxBytes": 1024 * 1024 * 10,  # 10 MB
            "backupCount": 10,
        },
...
AUTHENTICATION_BACKENDS = [
    ...
    "openvtb.accounts.backends.UserModelEmailBackend",
    "django.contrib.auth.backends.ModelBackend",
]

SESSION_COOKIE_NAME = "openvtb_sessionid"
...
CSRF_FAILURE_VIEW = "openvtb.accounts.views.csrf_failure"
...
TWO_FACTOR_WEBAUTHN_RP_NAME = "openvtb"
...
ELASTIC_APM = {
    "SERVICE_NAME": f"openvtb {ENVIRONMENT}",
